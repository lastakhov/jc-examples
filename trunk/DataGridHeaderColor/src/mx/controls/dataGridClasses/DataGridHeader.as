 ...
 * 
 * 
 * This is a modified version of the Flex 3.2.0 SDK DataGridHeader.as class.
 * This version has the following added functionality over the standard implementation:
 * 
 * <ul>
 *    <li>Specify a header (gradient) header color when the mouse over and mouse down events occur over the header.</li>
 * </ul>
 * 
 * The colors are specified via the <code>startColor</code> and <code>endColor</code> style attributes. These colors define
 * the start and end of the gradient fill. For a solid fill color, use the same color for both the start and end.
 * 
 * *  <p>
 *  The <code>&lt;mx:DataGridHeader&gt;</code> adds the following new styles
 * attributes:
 *  </p>
 *  <pre>
 *  &lt;mx:DataGridHeader
 ...
 *  /&gt; 
 */
[Style(name="startColor",type="Number",format="Color",inherit="no")]
[Style(name="endColor",type="Number",format="Color",inherit="no")]
public class DataGridHeader extends DataGridHeaderBase
{
    ...
    protected function mouseOverHandler(event:MouseEvent):void
    {
        ...
        if (dataGrid.enabled && dataGrid.sortableColumns && dataGrid.headerVisible)
        {
            ...
            if (visibleColumns[i].sortable)
            {
                ...
                this.drawGradientBackGround(s, r.x, 0, visibleColumns[i].width, cachedHeaderHeight - 0.5, r);
            }
        }
	...
	/**
	 * Draws a gradient background color.
	 * 
	 * The start- and endcolor of the gradient are specified via the styles <code>startColor</code> and <code>endColor</code>.
	 */    
    private function drawGradientBackGround(indicator:Sprite, x:Number, y:Number, w:Number, h:Number, itemRenderer:IListItemRenderer):void {
		var g:Graphics = indicator.graphics;
		g.clear();
		...
		var colors:Array = [ getStyle("startColor"), getStyle("startColor"), getStyle("endColor") ];
		var ratios:Array = [ 0, 60, 255 ];
		var alphas:Array = [ 1.0, 1.0, 1.0 ];
