To run the examples
1. Unzip the ga-patternimage<VERSION>.zip to a directory.
...
java -cp .;<PATH_TO_UNZIPPED_ARCHIVE/libs/jgap.jar;<PATH_TO_UNZIPPED_ARCHIVE/libs/log4j.jar nl.jamiecraane.patternexample.ImageDisplay

To import the source files in your favorite IDE:
1. Unzip the ga-patternimage<VERSION>.zip to a temporary location
