...
java -cp .;<PATH_TO_UNZIPPED_ARCHIVE/libs/jgap.jar;<PATH_TO_UNZIPPED_ARCHIVE/libs/log4j.jar nl.jamiecraane.gahelloworld.GaHelloWorld
...
5. compile and run the class with the main method: GaHelloWorld